    ...
    <div class="container">
      ...
      <div class="cards-grid">
        ...
        <div class="card">
          ...
          <p class="card-text">
            We’re developing Sc.AI to advance science and innovative breakthroughs for the benefit of all
          </p>
        </div>
        </div>
        ...
        <div class="card">
          ...
          <p class="card-text">
            Sc.AI provides a seamless interface to your research results and thereby enhances your potential to monetize your findings. You define the commercial terms, whether it’s open source, pay-per-use, fixed licensing, or another model of your choice</p>
        </div>
        </div>
...
const cards = [
  ...
  },
  {
    ...
    text: "Sc.AI provides easy access to supercomputer infrastructure at economical prices",
  },
  {
    icon: "/assets/image/icons/valorize-icon.svg",
    alt: "Valorize",
    title: "Valorize your research",
    text: "Sc.AI provides a seamless interface to your research results and thereby enhances your potential to monetize your findings. You define the commercial terms, whether it’s open source, pay-per-use, fixed licensing, or another model of your choice",
  },
  {
    icon: "/assets/image/icons/customerbase-icon.svg",
    alt: "Customer base",
    title: "Grow your customer base",
    text: "For commercial vendors, Sc.AI offers an add-on layer that enhances and simplifies the user interface. This reduces the time and expertise needed to set up simulations, making your products more accessible to a broader user base.",
  },
  {
    icon: "/assets/image/icons/legal-icon.svg",
    alt: "Legal & IP",
    title: "Integrated legal and IP management",
    text: "When entities connect on the Sc.AI platform, it automatically documents interactions and generates legal contracts, ensuring that your rights and intellectual property are always protected.",
  },
];
</script>
